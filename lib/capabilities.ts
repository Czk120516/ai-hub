...
export const CAPABILITIES: Capability[] = [
  ...
  },
  {
    ...
    icon: "Activity",
    systemPrompt:
      "本能力的实际答复由服务端「Chen-1.0 本地诊断引擎」生成，不调用 DeepSeek 或任何外部大模型——此系统提示词仅作能力描述展示，不参与实际推理。前端会拉取 /api/admin/server-status 的真实指标并注入，由诊断引擎据此输出结构化中文报告（整体健康度 / 运行时长 / 内存资源 / 健康检查明细 / 风险 / 建议 / 业务数据 / 环境限制）。该能力无网络依赖、不消耗 LLM 额度、零额外延迟。",
